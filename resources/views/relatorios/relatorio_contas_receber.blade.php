...
<header>
	<div class="headReport" style="display:flex;justify-content:  padding-top:1rem">
		...
		@else
		<img src="{{'data:image/png;base64,' . base64_encode(file_get_contents(@public_path('imgs/htc.png')))}}" alt="Logo" class="mb-2">
		@endif
		...
		<tbody>
			<tr>
				...
				<td class="text-right">
					...
					@else
					<img src="{{'data:image/png;base64,' . base64_encode(file_get_contents(@public_path('imgs/htc.png')))}}" alt="Logo" class="mr-3">
					@endif
				</td>
			</tr>
		</tbody>
