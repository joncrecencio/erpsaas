...
class Pdf extends AbstractPdf implements PdfContract
{
    ...
    public function setBoleto($dest = self::OUTPUT_STANDARD, $save_path = null, $nameFile = null)
    {
        if ($this->totalBoletos == 0) {
            throw new \Exception('Nenhum Boleto adicionado');
        }
        ...
        $this->Output(public_path('boletos/'.$nameFile.'.pdf'), 'F');
        return $nameFile;
    }

    public function setBoletoAux($dest = self::OUTPUT_STANDARD, $save_path = null, $nameFile = null)
    {
        if ($this->totalBoletos == 0) {
            throw new \Exception('Nenhum Boleto adicionado');
        }
